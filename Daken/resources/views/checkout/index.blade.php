                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="text" id="order_notes" name="order_notes" class="form-control form-control-lg "  placeholder="Notes about your order, e.g. special notes for delivery/quantity." />
                                    @error('order_notes')
                                        <div class="form-error">
                                            {{ $message }}
                                        </div>
